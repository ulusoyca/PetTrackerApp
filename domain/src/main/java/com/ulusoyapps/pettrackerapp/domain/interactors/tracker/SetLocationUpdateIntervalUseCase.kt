...
class SetLocationUpdateIntervalUseCase
@Inject constructor(
    private val trackerRepository: TrackerRepository
) {
    suspend operator fun invoke(trackerId: Long, intervalInMs: Long): Result<Unit, DomainMessage> {
        return trackerRepository.setLocationUpdatePeriodInMs(trackerId, intervalInMs)
    }
}